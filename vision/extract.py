...
def extract_game_region(region: dict) -> np.ndarray:
...
def extract_obstacles_region(region: np.ndarray, obstacle1: dict, obstacle2: dict) -> tuple:
...
def extract_sky_region(region: np.ndarray, sky: dict) -> np.ndarray:
